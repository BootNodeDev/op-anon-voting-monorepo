...
export const onBoardCSS = css`
  :root {
    ...
    --onboard-wallet-button-background: ${({ theme: { button } }) =>
      button.primary.backgroundColor};
    --onboard-wallet-button-background-hover: ${({ theme: { button } }) =>
      button.primary.backgroundColorHover};
    --onboard-wallet-button-border-color: ${({ theme: { button } }) => button.primary.borderColor};
    --onboard-wallet-button-color: ${({ theme: { button } }) => button.primary.color};
